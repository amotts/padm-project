...
class Body:
    ...
    def CalcSpatialInertiaInBodyFrame(self, *args, **kwargs): ...
...
class BodyFrame_𝓣AutoDiffXd𝓤(Frame_TAutoDiffXdU):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, *args, **kwargs) -> None: ...

class BodyFrame_𝓣Expression𝓤(Frame_TExpressionU):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, *args, **kwargs) -> None: ...
...
class Body_𝓣AutoDiffXd𝓤:
    ...
    def body_frame(self) -> BodyFrame_TAutoDiffXdU: ...
    @overload
    def default_mass(self) -> float: ...
    @overload
    def default_mass(self) -> Any: ...
...
class Body_𝓣Expression𝓤:
    ...
    def body_frame(self) -> BodyFrame_TExpressionU: ...
    @overload
    def default_mass(self) -> float: ...
    @overload
    def default_mass(self) -> Any: ...
...
class DoorHingeConfig:
    ...
    catch_torque: Incomplete
    catch_width: Incomplete
    dynamic_friction_torque: Incomplete
    motion_threshold: Incomplete
    spring_constant: Incomplete
    spring_zero_angle_rad: Incomplete
    static_friction_torque: Incomplete
    viscous_friction: Incomplete
...
class Joint_𝓣AutoDiffXd𝓤:
    ...
    def acceleration_lower_limits(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    def acceleration_upper_limits(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    def child_body(self) -> Body_TAutoDiffXdU: ...
    def default_positions(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    ...
    def num_positions(self) -> int: ...
    def num_velocities(self) -> int: ...
    def parent_body(self) -> Body_TAutoDiffXdU: ...
    def position_lower_limits(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    def position_start(self) -> int: ...
    def position_suffix(self, arg0: int) -> str: ...
    def position_upper_limits(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
...
class Joint_𝓣Expression𝓤:
    ...
    def acceleration_lower_limits(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    def acceleration_upper_limits(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    def child_body(self) -> Body_TExpressionU: ...
    def default_positions(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    ...
    def num_positions(self) -> int: ...
    def num_velocities(self) -> int: ...
    def parent_body(self) -> Body_TExpressionU: ...
    def position_lower_limits(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    def position_start(self) -> int: ...
    def position_suffix(self, arg0: int) -> str: ...
    def position_upper_limits(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
...
class LinearBushingRollPitchYaw_𝓣AutoDiffXd𝓤(ForceElement_TAutoDiffXdU):
    ...
    def link0(self) -> Body_TAutoDiffXdU: ...
    def link1(self) -> Body_TAutoDiffXdU: ...
    def torque_damping_constants(self) -> numpy.ndarray[numpy.float64[3, 1]]: ...
    def torque_stiffness_constants(self) -> numpy.ndarray[numpy.float64[3, 1]]: ...
...
class LinearBushingRollPitchYaw_𝓣Expression𝓤(ForceElement_TExpressionU):
    ...
    def link0(self) -> Body_TExpressionU: ...
    def link1(self) -> Body_TExpressionU: ...
    def torque_damping_constants(self) -> numpy.ndarray[numpy.float64[3, 1]]: ...
    def torque_stiffness_constants(self) -> numpy.ndarray[numpy.float64[3, 1]]: ...
...
class LinearSpringDamper_𝓣AutoDiffXd𝓤(ForceElement_TAutoDiffXdU):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, bodyA: Body_TAutoDiffXdU, p_AP: numpy.ndarray[numpy.float64[3, 1]], bodyB: Body_TAutoDiffXdU, p_BQ: numpy.ndarray[numpy.float64[3, 1]], free_length: float, stiffness: float, damping: float) -> None: ...
    def bodyA(self) -> Body_TAutoDiffXdU: ...
    def bodyB(self) -> Body_TAutoDiffXdU: ...
    def damping(self) -> float: ...
    def free_length(self) -> float: ...
    def p_AP(self) -> numpy.ndarray[numpy.float64[3, 1]]: ...
    def p_BQ(self) -> numpy.ndarray[numpy.float64[3, 1]]: ...
...
class LinearSpringDamper_𝓣Expression𝓤(ForceElement_TExpressionU):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, bodyA: Body_TExpressionU, p_AP: numpy.ndarray[numpy.float64[3, 1]], bodyB: Body_TExpressionU, p_BQ: numpy.ndarray[numpy.float64[3, 1]], free_length: float, stiffness: float, damping: float) -> None: ...
    def bodyA(self) -> Body_TExpressionU: ...
    def bodyB(self) -> Body_TExpressionU: ...
    def damping(self) -> float: ...
    def free_length(self) -> float: ...
    def p_AP(self) -> numpy.ndarray[numpy.float64[3, 1]]: ...
    def p_BQ(self) -> numpy.ndarray[numpy.float64[3, 1]]: ...
...
class RigidBody(Body):
    ...
    def SetSpatialInertiaInBodyFrame(self, *args, **kwargs): ...
    def default_com(self) -> numpy.ndarray[numpy.float64[3, 1]]: ...
    def default_mass(self) -> float: ...
    def default_rotational_inertia(self, *args, **kwargs): ...
    def default_spatial_inertia(self, *args, **kwargs): ...
    def default_unit_inertia(self, *args, **kwargs): ...

class RigidBody_𝓣AutoDiffXd𝓤(Body_TAutoDiffXdU):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
...
class RigidBody_𝓣Expression𝓤(Body_TExpressionU):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, body_name: str, M_BBo_B: SpatialInertia) -> None: ...
...
class _TemporaryName_N5drake9multibody9BodyFrameIN5Eigen14AutoDiffScalarINS2_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEEEE(Frame_TAutoDiffXdU):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, *args, **kwargs) -> None: ...

class _TemporaryName_N5drake9multibody9BodyFrameINS_8symbolic10ExpressionEEE(Frame_TExpressionU):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, *args, **kwargs) -> None: ...
...
class _TemporaryName_N5drake9multibody9RigidBodyIN5Eigen14AutoDiffScalarINS2_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEEEE(Body_TAutoDiffXdU):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, body_name: str, M_BBo_B: SpatialInertia) -> None: ...
...
class _TemporaryName_N5drake9multibody9RigidBodyINS_8symbolic10ExpressionEEE(Body_TExpressionU):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, body_name: str, M_BBo_B: SpatialInertia) -> None: ...
